...
<div class="todo">
  ...
  <h1><font color="red">Listado completo de los tipos de articulos</font></h1>
  <div id="contenido">
    <div style="text-align:center;">
      <table border="1" style="margin: 0 auto; width: 800px;">
  		<thead>
  			<th>Id tipo de articulo</th>
  			<th>Familia</th>
  			<th>Nombre</th>
  		</thead>
	<?php
      // Create connection
    	...
    	$password = "";
  		...
  		$sentencia = "SELECT *
              	    FROM familia f, tipo t
          		      where t.familia_id_t = f.id_familia";
      ...
      $resultado=mysqli_query($link,$sentencia) or die ("Problemas al insertar".mysqli_error($con));
        ...
        echo "<tr>";
            echo "<td>"; echo $filas['id_tipo']; echo "</td>";
          	echo "<td>"; echo $filas['nomb_familia']; echo "</td>"; //Listo el nombre de la familia del tipo
